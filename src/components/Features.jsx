...
const features = [
  ...
  { icon: 'tuples', title: 'Tuples', desc: 'Built-in heterogeneous tuples with tup(a, b, c) syntax. Access elements by position with .0, .1, .2 notation.' },
  ...
  { icon: 'collections', title: 'Collection Literals', desc: 'Native syntax for arrays and maps [], [:]. Static arrays with fill<T>(size).' },
